      ...
      <section className="section bg-brand-lilac-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-body text-brand-gray mb-8">
            Professional home cleaning services in Plano
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div>
              <h2 className="font-fredoka text-h2-mobile md:text-h2 text-brand-purple mb-4">
                About Cleaning in Plano
              </h2>
              <p className="text-body text-brand-gray mb-4">
                At Anisaya Cleaning, we've been proudly serving Plano with professional house cleaning for {BUSINESS_INFO.yearsExperience} years. Our team is fully background-checked, insured, and bonded.
              </p>
              <p className="text-body text-brand-gray mb-4">
                Whether you need a one-time deep clean, regular maintenance cleaning, or move-in/move-out service, we have the expertise to leave your Plano home sparkling.
              </p>
            </div>
